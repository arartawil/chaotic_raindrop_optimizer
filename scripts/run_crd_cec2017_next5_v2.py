"""
Run the 12 CRD variants on CEC2017 indices 15..19 (next 5 after the v1 batch).
...
N_RUNS = 30
DIM = 30
START_IDX = 15        # picks up where the previous next-5 script ended
N_FUNC = 5            # next 5 functions: indices 15..19
