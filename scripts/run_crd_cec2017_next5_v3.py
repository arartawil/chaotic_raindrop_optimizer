"""
Run the 12 CRD variants on CEC2017 indices 20..24 (next 5 after the v2 batch).
...
N_RUNS = 30
DIM = 30
START_IDX = 20        # picks up where the v2 next-5 script ended
N_FUNC = 5            # next 5 functions: indices 20..24
